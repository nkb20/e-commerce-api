...
const handleGetAllProduct = async function (req, res, next) {
...
const handleGetProductById = async function (req, res, next) {
    ...
    module.exports = { handleAddProduct, handleUpdateProduct, handleDeleteProduct, handleGetAllProduct, handleGetProductById }